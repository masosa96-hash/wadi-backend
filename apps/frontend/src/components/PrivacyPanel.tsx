...
export default function PrivacyPanel() {
    ...
    const handleExportData = async () => {
        ...
        try {
            ...
            link.href = url;
            link.download = `wadi-data-export-${new Date().toISOString().split('T')[0]}.json`;
        ...
        <div style={{
            ...
            <div style={{
                ...
                <p style={{
                    ...
                    Descarga una copia de todos tus datos en formato JSON. Incluye conversaciones, proyectos y configuración.
                </p>
                {exportSuccess && (
                    <div style={{
                        ...
                        <div style={{ display: 'flex', gap: theme.spacing.sm }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    borderRadius: theme.borderRadius.md,
                                    color: '#FFFFFF',
                                    cursor: (deleting || deleteConfirmText !== 'ELIMINAR') ? 'not-allowed' : 'pointer',
                                    fontSize: theme.typography.fontSize.base,
                                    fontWeight: theme.typography.fontWeight.medium,
                                    opacity: (deleting || deleteConfirmText !== 'ELIMINAR') ? 0.5 : 1,
                                }}
                            >
