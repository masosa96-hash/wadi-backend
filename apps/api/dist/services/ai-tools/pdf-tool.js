...
exports.PDFAnalysisTool = void 0;
...
class PDFAnalysisTool extends framework_1.AITool {
    constructor() {
        super(...arguments);
        this.id = "pdf_analyzer";
        this.name = "PDF Analysis";
        this.description = "Extract text, structure, and metadata from PDF documents for analysis";
    ...
    async execute(params, context) {
        ...
        try {
            ...
            if (file_path.startsWith("data:application/pdf;base64,")) {
                ...
                // Local file path
                pdfBuffer = (0, fs_1.readFileSync)(file_path);
            }
            // Parse PDF
...
exports.PDFAnalysisTool = PDFAnalysisTool;
