...
export class ImageAnalysisTool extends AITool {
  ...
  readonly name = "Image Analysis";
  readonly description = "Analyze images, extract text (OCR), identify objects, and describe visual content using AI vision";
        ...
        messages: [
          {
            ...
            content: [
              { type: "text", text: prompt },
              {
                ...
                image_url: {
                  url: image_url,
                  detail: detail_level as "low" | "high" | "auto",
                },
              },
            ],
          },
  ...
  private getPromptForAnalysisType(analysisType: string): string {
    switch (analysisType) {
      case "describe":
