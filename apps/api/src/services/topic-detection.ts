      ...
      [
        {
          role: "system",
          content:
            "Sos un analizador de conversaciones. Respondés SOLO en formato JSON válido, sin texto adicional.",
        },
        {
          role: "user",
 ...
 */
export async function generateWorkspaceName(messages: Message[]): Promise<string> {
  try {
      ...
      [
        {
          role: "system",
          content:
            "Generá un nombre corto y descriptivo (máximo 4 palabras) para un workspace basado en la conversación. Respondé SOLO el nombre, sin comillas ni puntuación adicional.",
        },
        {
          role: "user",
 ...
 */
export async function extractConversationTopics(messages: Message[]): Promise<string[]> {
  try {
      ...
      [
        {
          role: "system",
          content:
            'Extraé los 3-5 temas principales de esta conversación. Respondé SOLO en formato JSON: {"topics": ["tema1", "tema2", ...]}',
        },
        {
          role: "user",
