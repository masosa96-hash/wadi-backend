...
1. **[CLOUD_DEPLOYMENT_GUIDE.md](file:///E:/WADI/CLOUD_DEPLOYMENT_GUIDE.md)** - Complete guide for deploying to Vercel and Render/Railway
...
### Option 1: Render (as documented in render.yaml)
- Uses the configuration in [render.yaml](file:///E:/WADI/render.yaml)
- Environment variables set directly in Render dashboard
- JWT_SECRET can be auto-generated by Render

### Option 2: Railway (as documented in railway.json)
- Uses the configuration in [railway.json](file:///E:/WADI/railway.json)
- Environment variables set in Railway dashboard
- **Important**: Railway requires a secret named `JWT_SECRET` to be created in the Variables/Secrets UI
- The JWT_SECRET value should be your Supabase JWT secret (found in Supabase project settings)
...
2. Deploy backend to Render or Railway using the respective configuration files
