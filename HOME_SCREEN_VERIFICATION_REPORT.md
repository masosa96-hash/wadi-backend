...
```css
@media (max-width: 380px)  → Single column workspace grid
@media (min-width: 768px)  → Enhanced mobile frame styling
@media (min-width: 1024px) → Centered desktop "phone" layout
```
